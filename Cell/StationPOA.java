 ...
 implements Cell.StationOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("setStation", new java.lang.Integer (2));
    _methods.put ("sendSMS", new java.lang.Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // Cell/Station/setStation
       {
         Cell.Station objRef = Cell.StationHelper.read (in);
         String stationName = in.read_string ();
         int $result = (int)0;
         $result = this.setStation (objRef, stationName);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 3:  // Cell/Station/sendSMS
       {
