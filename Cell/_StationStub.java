...
public class _StationStub extends org.omg.CORBA.portable.ObjectImpl implements Cell.Station
{
  ...
  public int setStation (Cell.Station objRef, String stationName)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setStation", true);
                Cell.StationHelper.write ($out, objRef);
                $out.write_string (stationName);
                $in = _invoke ($out);
                int $result = $in.read_long ();
                ...
                return setStation (objRef, stationName        );
            } finally {
                _releaseReply ($in);
            }
  } // setStation
